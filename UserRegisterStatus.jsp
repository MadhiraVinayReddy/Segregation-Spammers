...
<head>
<title>User Registration Status Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>User Registration Status..</span></h2>          
          <div class="clr"></div>          
		  <p>&nbsp;</p>
		  <%
					...
					String paramname=null,community=null,uname=null,pass=null,email=null,mno=null,addr=null,dob=null,gender=null,image=null,cloud=null,bin = "";
		          ...
		          <p class="style18 style24 style2">User Name Already Exist, Try Different Username..</p>
		          ...
		          <%
					  ...
					  String ac_status = "Normal";
					  String ac_status_reason = "No Spamming Activities";
					  String interaction_reason = ".";
					  
PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,address,dob,gender,community,status,image,ac_status,ac_status_reason,interaction_reason) values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
						...
						ps.setString(8,community);
						ps.setString(9,status);
				
						ps.setBinaryStream(10, (InputStream)fs, (int)(file1.length()));	
						ps.setString(11,ac_status);	
						ps.setString(12,ac_status_reason);
				        ps.setString(13,interaction_reason);
						...
						{
						%>
                  <p class="style23 style1">Registration Successfull.</p>
		          <p class="style19">&nbsp;</p>
