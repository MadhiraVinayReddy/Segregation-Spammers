...
<head>
<title>Add Spam Filter Status Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Add Spam Filter Status..</span></h2>          
          <div class="clr"></div>          
		  <p>&nbsp;</p>
		  <p>
					...
					String title=null,filtername=null,spamt="Spam",location1=null,sk=null,bin = "", paramname=null;
					...
					try {
						...
						FileInputStream fs1 = null;
			 			String query1="select * from spam_filter  where filtername='"+filtername+"' "; 
          ...
          <p class="style37 style7 style4">Filter Name Already Exist..</p>							
			        ...
			        <p>&nbsp;</p>
			        <p><a href="Admin_AddSpamFilter.jsp" class="style15 style38">Back</a><a href="Admin_AddSpamFilter.jsp" class="style8 style15"></a></p>
			        <p>
                      <%
			           ...
			           String dt = strDate + "   " + strTime;
										...
										if(!filtername.equals(""))
										{
											...
											String strQuery2 = "insert into spam_filter(filtername,Stype) values('"+filtername+"','"+spamt+"')";
			        ...
			        <p>&nbsp;</p>
			        <p><a href="Admin_AddSpamFilter.jsp" class="style15 style38">Back</a></p>
			        <%
											 }
											 else
											 {
														...
														%>
			        <p class="style37 style7 style6">Please Input Spam Filter Name..</p>
			        <p class="style37">&nbsp;</p>
			        <a href="Admin_AddSpamFilter.jsp" class="style15 style38">Back</a>
			        </p>
			        <%
