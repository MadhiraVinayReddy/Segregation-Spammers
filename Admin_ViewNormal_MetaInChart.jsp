...
<head>
<title>Normal MetaData Users In Chart Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Number of Normal Behaviours Based On Tweet MetaData In Chart</span></h2>          
          <div class="clr"></div>          
		  <p>&nbsp;</p>
		  <%
		  String community=request.getParameter("community");
		  int nrmt=Integer.parseInt(request.getParameter("nrmt"));
		  %>
		  
		  <iframe width="500" height="350" src="Admin_ViewNormal_MetaInChart1.jsp?community=<%=community%>&nrmt=<%=nrmt%>"></iframe>
			  				<br/>
			  				<span class="style3 style1">(Number of Normal Behaviours Based On Tweet MetaData)</span>
		  <p>&nbsp;</p>
		  
		 
		<div align="right" class="style22"><a href="Admin_ViewCommunitySpamMeta.jsp?community=<%=community%>" class="style11">Back</a></div>
