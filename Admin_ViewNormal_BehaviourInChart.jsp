...
<head>
<title>Normal Behaviour In Chart Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Number of Normal Behaviours Based On Interactions In Chart</span></h2>          
          <div class="clr"></div>          
		  <p>&nbsp;</p>
		  <%
		  String community=request.getParameter("community");
		  int nrmct=Integer.parseInt(request.getParameter("nrmct"));
		  %>
		  
		  <iframe width="500" height="350" src="Admin_ViewNormal_BehaviourInChart1.jsp?community=<%=community%>&nrmct=<%=nrmct%>"></iframe>
			  				<br/>
			  				<span class="style3 style1">(Number of Normal Behaviours Based On Interactions)</span>
		  <p>&nbsp;</p>
