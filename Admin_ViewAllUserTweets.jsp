...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>All User Tweets..</span></h2>          
          <div class="clr"></div>          
		  <p>&nbsp;</p>
		   <p>&nbsp;</p>
		    <p>&nbsp;</p>
		  ...
		  <table width="500" border="1" align="center"  cellpadding="0" cellspacing="0"  >
               <tr bgcolor="#FFFFFF">
                 <td  width="25" height="34" valign="baseline" bgcolor="#FFFFFF" style="color: #2c83b0;"><div align="center" class="style4 style6" ><strong>SI NO</strong></div></td>
				  ...
				  <td  width="176" height="34" valign="baseline" bgcolor="#FFFFFF" style="color: #2c83b0;"><div align="center" class="style4 style6" ><strong> Community </strong></div></td>
            ...
            <tr>
			 ...
			 <td  width="105" align="left" valign="middle" height="23"><a href="Admin_ViewTweetInteractions.jsp?up_Name=<%=s0%>&type=<%="Admin_Tweet"%>&tname=<%=s1%>&id=<%=j%>&score=<%=s%>" class="style8" style="color:#FF3333">View Interactions</a> </td>
            ...
            <%
					...
					if(count==0){out.print("User's Have Not Uploaded Any Tweets");}
