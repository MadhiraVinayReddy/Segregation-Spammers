    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="clr"></div>          
		  <p><img src="images/Login.png" width="271" height="146" /></p>
		  <form id="form1" name="form1" method="post" action="UserAuthentication.jsp">
				   					
					<table width="464" border="0" cellspacing="2" cellpadding="2">
					  <tr>
                        <td width="149" height="33"><div align="justify" class="style3"><span class="style8 style38 style5 ">Select Community </span></div></td>
                        <td width="274"><label>
                          <select id="s1" name="community">
                      ...
                      <tr>
                        <td width="197" height="46" align="justify"><span class="style2 style34"><strong>
                          <label for="name">User Name (required)</label>
                        </strong></span> </td>
                        <td width="253"><input id="name" name="userid" class="text" /></td>
                      </tr>
                      <tr>
                        <td height="40" align="justify"><span class="style2 style34"><strong>Password (required)</strong></span></td>
