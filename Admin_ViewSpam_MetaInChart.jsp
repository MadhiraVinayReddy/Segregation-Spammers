...
<head>
<title>Spam MetaData Users In Chart Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Number of Spamming Behaviours Based On Tweet MetaData In Chart</span></h2>          
          <div class="clr"></div>          
		  <p>&nbsp;</p>
		  <%
		  String community=request.getParameter("community");
		  int spmt=Integer.parseInt(request.getParameter("spmt"));
		  %>
		  
		  <iframe width="500" height="350" src="Admin_ViewSpam_MetaInChart1.jsp?community=<%=community%>&spmt=<%=spmt%>"></iframe>
			  				<br/>
			  				<span class="style3 style1">(Number of Spamming Behaviours Based On Tweet MetaData)</span>
		  <p>&nbsp;</p>
